...
class MTDataset(Dataset):
    def __init__(self, data_path):
        self.out_cn_sent,self.out_en_sent  = self.get_dataset(data_path, sort=True)
...
#         self.EOS = self.sp_eng.eos_id()  # 3
    ...
    def get_dataset(self, data_path, sort=False):
        """把中文和英文按照同样的顺序排序, 中文句子长度排序的(句子下标)顺序为基准"""
    ...
    #    print(out_en_sent[0])
     #   print(out_cn_sent[0])
        return  out_cn_sent,out_en_sent
